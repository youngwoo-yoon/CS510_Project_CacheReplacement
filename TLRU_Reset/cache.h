...
#define CACHE_HIGHLY_ASSOC(cp)	((cp)->assoc > 20) /* By HC */
...
struct cache_blk_t
{
  ...
  unsigned int LRU_behavior; //By HC
...
struct cache_set_t
{
  ...
  struct cache_blk_t *way_tail;	/* SG: tail of cluster of way list, LRU of clustered block, and also pre-MRU of un-clustered blocks */
...
md_addr_t center_of_cluster;   //SG
md_addr_t size_half_of_cluster;     //SG
